        ...
        <div class="container-fluid" style=" background-color: #fff; padding: 11px;">
            <div class="row">
                <div class="col-lg-2 order-lg-1 order-2">
                    <ul class="image_list">
                        <li><img src="<?php echo BASE_URL . $data["product_image1"]; ?>" alt=""></li>
                        <li><img src="<?php echo BASE_URL . $data["product_image2"]; ?>" alt=""></li>
                        <li><img src="<?php echo BASE_URL . $data["product_image3"]; ?>" alt=""></li>
                    </ul>
                </div>
                <div class="col-lg-4 order-lg-2 order-1">
                    <div class="image_selected"><img src="<?php echo BASE_URL . $data["product_image1"]; ?>" alt=""></div>
                </div>
