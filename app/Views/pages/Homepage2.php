<style> 
    ...
    .carousel-caption h1 {color:#000;top:50px; bottom: auto; text-align:left; }
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="images\burst-kUqqaRjJuw0-unsplash.jpg" alt="Los Angeles">
      <div class="carousel-caption justify-content-center">
        <div class="col-md-7">
            <h1 class="pb-2"><strong>Welcome to SiliconTT</strong> </h1>
            <h4>The best computer store in T&T</h4>
        </div>
      </div>   
    </div>
